...
echo "Installation of Piaware completed...."

echo "Starting installation of dump1090-fa...."
...
echo "Piaware and dump1090-fa Installed and configured......"

read -rsp $'Press any key to start creation of files for 2nd instances of dump1090-fa and piaware...\n' -n1 key

echo "(1) Creating dump1090-fa2 service file......"
...
echo ""
echo "(2) Creating dump1090-fa2 startup file......"
...
echo ""
echo "(3) Creating dump1090-fa2 Config file......"
...
echo ""
echo "(4) Creating lighttpd Config file......"
...
echo ""
(5) Creating Service file for Piaware 2
...
echo ""
echo "(6) Creating piaware2 Config file......"
...
echo "(7) Creating directory /var/cache/piaware2"
...
echo -e "For 1st feeder add feeder ID by following command:"
echo -e "sudo piaware-config feeder-id xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
echo -e "For 2nd feeder add feeder ID, edit file piaware2.conf:"
...
echo -e "After reboot, go to your browser and check map on following addresses"
