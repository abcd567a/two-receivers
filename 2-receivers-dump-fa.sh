...
echo -e "\e[32m===============\e[39m"
echo -e "(1) If you dont have existing feeder-ids / Stations, and want to claim brand-new stations, go to this page:"
echo -e " https://flightaware.com/adsb/piaware/claim "
echo -e ""
echo -e "(2) If you already have feeder-id for 1st feeder, to add feeder ID, edit file piaware.conf:"
...
echo -e ""
echo -e "(3) If you already have feeder-id for 2nd feeder, to add feeder ID, edit file piaware2.conf:"
...
echo -e ""
echo -e "\e[31m(4) REBOOT RPi\e[39m\n"
echo -e "(5) After reboot, go to your browser and check map on following addresses"
