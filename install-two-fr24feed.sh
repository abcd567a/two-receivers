...
echo " "
echo -e "\e[01;33m    To restart 1st Copy of fr24feed:  sudo systemctl restart fr24feed  \e[39m"
echo -e "\e[01;35m    To restart 2nd Copy of fr24feed:  sudo systemctl restart fr24feed2  \e[39m"

echo " "
echo -e "\e[01;33m    To check log of 1st Copy of fr24feed:  cat /var/log/fr24feed/fr24feed.log  \e[39m"
echo -e "\e[01;35m    To check log of 2nd Copy of fr24feed:  cat /var/log/fr24feed2/fr24feed.log  \e[39m"
echo " "
echo -e "\e[01;33m    To check status of 1st Copy of fr24feed:  sudo fr24feed-status  \e[39m"
echo -e "\e[01;35m    To check status of 2nd Copy of fr24feed:  sudo fr24feed2-status  \e[39m"
echo " "
